...
angular.module('myApp.controllers', ['myApp.i18n'])
  ...
  .controller('AppImHistoryController', function ($scope, $location, $timeout, $modal, $rootScope, toaster, _, MtpApiManager, AppUsersManager, AppChatsManager, AppMessagesManager, AppPeersManager, ApiUpdatesManager, PeersSelectService, IdleManager, StatusManager, NotificationsManager, ErrorService, GeoLocationManager) {
    ...
    reviewgram.initModalActions($scope, $rootScope, $modal);
  ...
  .controller(reviewgram.settingsControllerName, function($rootScope, $scope, $modal, AppUsersManager, MtpApiManager, $modalInstance) { reviewgram.repoSettingsController($rootScope, $scope, $modal, AppUsersManager, MtpApiManager, $modalInstance); })
  .controller(reviewgram.makeCommitControllerName, function($rootScope, $scope, $modal, AppUsersManager, AppPeersManager, MtpApiManager, $modalInstance) { reviewgram.makeCommitController($rootScope, $scope, $modal, AppUsersManager, AppPeersManager, MtpApiManager, $modalInstance); })
