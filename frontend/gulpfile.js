...
gulp.task('server', function (done) {
  ...
  ).listen(8000, "0.0.0.0", done)
})

gulp.task('watch', gulp.series('server', 'less', function () {
...
gulp.task('bump', gulp.series('bump-version-manifests', 'bump-version-config', function () {
